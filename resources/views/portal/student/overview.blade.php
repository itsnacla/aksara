        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div class="space-y-6 md:space-y-8">
                ...
                {{-- Kartu Pelajar Quick Access --}}
                <div class="bg-white rounded-[20px] p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
                    <div class="absolute -right-4 -top-4 w-20 h-20 bg-teal-50 rounded-full opacity-50"></div>
                    <div class="flex items-center gap-3 mb-4 relative z-10">
                        ...
                        <h3 class="font-bold text-[13px] text-gray-500 uppercase tracking-widest">Kartu Pelajar</h3>
                    </div>
                    <div class="relative z-10 flex flex-col gap-3">
                        <p class="text-xs text-gray-500 leading-relaxed">Lihat, periksa, atau cetak Kartu Tanda Pelajar resmi Anda secara online.</p>
                        <button onclick="window.openProfileModal()" class="w-full inline-flex items-center justify-center gap-2 bg-primary text-white hover:bg-primary/95 text-xs font-semibold py-2.5 px-4 rounded-xl transition-all shadow-sm cursor-pointer hover:shadow-md">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                            <span>Lihat Profil & Kartu</span>
                        </button>
                    </div>
                </div>
            </div>
