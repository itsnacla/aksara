...
<div class="space-y-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <!-- Leave Request Card -->
        <a href="{{ route('leaves.index') }}" class="bg-white rounded-[2rem] p-8 shadow-sm hover:shadow-md transition-shadow group">
            <div class="bg-[var(--color-surface-container-low)] w-12 h-12 rounded-2xl flex items-center justify-center mb-6 text-primary group-hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
            </div>
            <h3 class="text-xl font-bold mb-2">Izin / Sakit</h3>
            <p class="text-gray-500 text-sm mb-6">Ajukan atau lihat riwayat izin.</p>
            <div class="bg-[var(--color-surface-container-low)] py-2 px-4 rounded-full text-xs font-bold inline-block uppercase">KELOLA IZIN</div>
        </a>
    </div>
