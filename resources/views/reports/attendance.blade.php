...
<body class="bg-gray-200 text-black p-8">
    ...
    <div class="max-w-5xl mx-auto bg-white p-10 shadow-lg print-container">
        ...
        <div class="flex justify-between mt-16 text-sm px-10">
            ...
            <div class="text-center w-64">
                <p>{{ ucwords(strtolower($school->village ?? '................')) }}, {{ $rombel && $rombel->academicYear && $rombel->academicYear->attendance_date ? \Carbon\Carbon::parse($rombel->academicYear->attendance_date)->translatedFormat('d F Y') : now()->translatedFormat('d F Y') }}</p>
